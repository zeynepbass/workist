  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/ilanlar/:kategori" element={<General />} />

        <Route path="/ilanlarim" element={<Ads />} />

        <Route path="/ilanlarim/:id" element={<AdsDetail />} />

        <Route path="/portfolyom" element={<Portfolyo />} />

        <Route path="/portfolyom/:id" element={<PortfolyoDetail />} />

        <Route path="/satislar" element={<Sales />} />

        <Route path="/siparisler/:id" element={<SalesDetail />} />

        <Route path="/siparisler" element={<Orders />} />

        <Route path="/istekler" element={<Request />} />

        <Route path="/yapilacaklar" element={<Todo />} />
