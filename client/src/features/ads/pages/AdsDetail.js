...
const HizmetFormu = () => {
    ...
    useEffect(() => {
        ...
        setForm({
            ...
            kodFiyatlandirma: {
                ...
                kaynakKod: Array.isArray(
                    details.kodFiyatlandirma
                )
                    ? details.kodFiyatlandirma.some(
            ...
            ekstraOzellikler: {
                hizliTeslimat:
                    details.extra?.includes(
                        "hizliTeslimat"
                    ) || false,

                fullHd:
                    details.extra?.includes("fullHd") ||
                    false,
            },
    ...
    const handleSubmit = (e) => {
        ...
        const ekstraOzelliklerCount =
            Object.values(
                form.ekstraOzellikler
            ).filter(Boolean).length;

        const totalSelectedCount =
            kodFiyatlandirmaCount +
            ekstraOzelliklerCount;
        ...
        return (
            <div className="text-center p-8">
                <p className="text-red-500">
                    İlan bilgileri yüklenirken bir hata oluştu.
                </p>
            </div>
        );
    }
    ...
    return (
        <form
            ...
            className="max-w-6xl mx-auto space-y-6 text-gray-800 h-[auto]"
        >
            <button
                type="button"
                onClick={handleBack}
            ...
            <div>
                ...
                <p className="text-gray-500 flex items-start">
                    ...
                    "Ben web sitenizi özgün tasarımlar
                    eşliğinde yönetebileceğiniz hale
                    getiriyorum" gibi bir cümle önerilir.
                </p>
