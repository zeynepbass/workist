...
export function Modal(){
  ...
  const iconMap = {
    "Grafik & Tasarım": (
      <img src="images/graphic-designer.png" width="50" height="50" />
    ),
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white w-full max-w-2xl p-6 rounded-md space-y-6">
            {step === 1 && (
              <>
                ...
                <p className="text-gray-400 italic">
                  Hadi, başlayalım. 😎 Ekleyeceğin portfolyo hangi ana
                  kategoriye giriyor?
                </p>
            ...
            {step === 2 && (
              <>
                <h2 className="text-xl font-semibold text-gray-400">
                  Peki, ekleyeceğin portfolyo{" "}
                  <span className="text-purple-400">{selectedCategory}</span>{" "}
                  kategorisinin hangi alanına giriyor?
                </h2>
                <p className="text-gray-500 italic">
                  Biraz daha Detail alalım!
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <div className="flex space-x-2 items-center">
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, fiyat: e.target.value })
                    }
